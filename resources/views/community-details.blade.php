...
@section('content')
        ...
        <div class="blog-details-right-wrapper">
            <div class="rts-blog-details-area-top bg-smooth">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row top-blog-details-start align-items-center">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="authore-bd-area">
                                        <div class="main">
                                            <img src="{{ URL::asset('build/images/blog/11.png') }}" alt="blog">
                                            <div class="info">
                                ...
                                <div class="col-lg-12 mt--30">
                                    <div class="main-image-big">
                                        <img src="{{ URL::asset('build/images/blog/10.jpg') }}" alt="blog-imaeg">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="blog-detail-inenr-area pt--45 rts-section-gapBottom plr_sm--5 bg-smooth">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="para-area-wrapper">
                                ...
                                <h4 class="title">10 Content creation tools to boost your productivity and make you more efficient</h4>
                                <p class="disc">
                                ...
                                <img class="mb--30" src="{{ URL::asset('build/images/blog/12.jpg') }}" alt="dsds">
