        ...
        <div class="col-lg-12">
            <div class="header-inner-one">
                <div class="left-logo-area">
                    <a href="/" class="logo">
                        <img src="{{ URL::asset('build/images/logo/logo-01.png') }}" alt="logo-image">
                    </a>
                    <div class="left-side-open-clouse" id="collups-left">
                        <img src="{{ URL::asset('build/images/icons/01.svg') }}" alt="icons">
                    </div>
                </div>
                <div class="header-right">
                    <div class="button-area">
                        <a href="javascript: void(0);" class="rts-btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#exampleModal" data-bs-whatever="@mdo">
                            <img src="{{ URL::asset('build/images/icons/02.svg') }}" alt="icons">
                            Update
                        </a>
                    </div>
                    <div class="action-interactive-area__header">
                        <div class="single_action__haeader search-action openuptip" flow="down" tooltip="Search">
                            ...
                            <div class="search-opoup slide-down__click">
                                <input type="text" placeholder="Search">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </div>
                        </div>
                        <div class="single_action__haeader notification openuptip" flow="down"
                            ...
                            <div class="notification_main_wrapper slide-down__click">
                                <h3 class="title">
                                    Notification<span class="count">5</span>
                                </h3>
                                    ...
                                    <ul class="notification__items">
                                        <li class="single__items">
                                            <a class="single-link" href="#">
                                                <div class="avatar">
                                                    <img src="{{ URL::asset('build/images/avatar/user.svg') }}"
                                                        alt="Popup Img" class="">
                                                </div>
                                                <div class="main-content">
                                                    <h5 class="name-user">
                                                        MR.Crow Kader
                                                        <span class="time-ago">1.3 hrs ago</span>
                                                    </h5>
                                                    <div class="disc">
                        ...
                        <div class="single_action__haeader language  user_avatar__information openuptip"
                            flow="down" tooltip="Language">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="single_action__haeader rts-dark-light openuptip" flow="down"
                            tooltip="Dark / Light" id="rts-data-toggle">
                            <div class="in-light">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="single_action__haeader user_avatar__information openuptip" flow="down"
                            tooltip="Profile">
                            <div class="avatar">
                                <img src="{{ URL::asset('build/images/avatar/01.png') }}" alt="avatar">
                            </div>
                            <div class="user_information_main_wrapper slide-down__click">
                                <div class="user_header">
                                    <div class="main-avatar">
                                        <img src="{{ URL::asset('build/images/avatar/user-2.svg') }}" alt="user">
                                    </div>
                                    <div class="user_naim-information">
                                        <h3 class="title">{{ Auth::user()->first_name }}
                                            {{ Auth::user()->last_name }}
                                        </h3>
                                        <span class="desig"> {{ Auth::user()->email }} </span>
                                    </div>
                                </div>
                                <div class="user_body_content">
                                    <ul class="items">
                                        <li class="single_items">
                                            <a class="hader_popup_link" href="{{ route('profile') }}">
                                        ...
                                        <li class="single_items">
                                            <a class="hader_popup_link" href="#">
                                                <i class="fa-light fa-person-snowmobiling"></i>
                                                Billing
                                            </a>
                                        </li>
                                        <li class="single_items">
                                ...
                                <div class="popup-footer-btn">
                                    <a href="{{ route('logout') }}" class="geex-content__header__popup__footer__link"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        Logout <i class="fa-light fa-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
