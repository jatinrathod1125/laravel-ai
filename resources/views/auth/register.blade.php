                                ...
                                <div class="body">
                                    ...
                                    @csrf
                                        <div class="input-wrapper text-start">
                                            ...
                                            <div>
                                                <input type="password" class="@error('password') is-invalid @enderror" name="password" placeholder="Enter your Confirm Password">
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <button class="rts-btn btn-primary">Create Account</button>
