    ...
    <div class="geex-sidebar__wrapper">
        <div class="geex-sidebar__header">
            <a href="index.html" class="geex-sidebar__logo">
                <img class="logo-lite" src="{{asset('img/logo-dark.svg') }}" alt="logo" />
                <img class="logo-dark" src="{{asset('img/logo-lite.svg') }}" alt="logo" />
            </a>
        </div>
        <nav class="geex-sidebar__menu-wrapper">
            <ul class="geex-sidebar__menu">
                <li class="geex-sidebar__menu__item has-children">
                    <a href="{{ route('admin.dashboard') }}" class="geex-sidebar__menu__link">
             ...
             C14.3431 5 13 6.34315 13 8C13 9.65685 14.3431 11 16 11Z" fill="#B9BBBD" />
                            <path d="M8 11C9.65685 11 11 9.65685 11 8C11 6.34315 9.65685 5 8 5
             C6.34315 5 5 6.34315 5 8C5 9.65685 6.34315 11 8 11Z" fill="#B9BBBD" />
                            <path d="M16 13C13.7909 13 12 14.7909 12 17V19H20V17
             C20 14.7909 18.2091 13 16 13Z" fill="#B9BBBD" />
                            <path d="M8 13C5.79086 13 4 14.7909 4 17V19H12V17
             C12 14.7909 10.2091 13 8 13Z" fill="#B9BBBD" />
                        </svg>
                    ...
                    <ul class="geex-sidebar__submenu">
                        <li class="geex-sidebar__menu__item">
                            <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--top">List</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--side">Create</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--light">Edit</a>
                        </li>
                    </ul>
                </li>
