...
<div class="geex-content">
    <div class="geex-content__header">
        ...
        @include('admin.components.header-actions')
    </div>
            ...
            <div class="geex-content__section geex-content__transaction">
                    ...
                    <div class="geex-content__section__header__content-part">
                        <ul class="nav nav-tabs geex-transaction-tab" id="geex-transaction-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="transaction-history-tab" data-bs-toggle="tab"
                                    data-bs-target="#transaction-history-content" type="button" role="tab"
                                    aria-controls="transaction-history-content" aria-selected="true">History</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="transaction-upcoming-tab" data-bs-toggle="tab"
                                    data-bs-target="#transaction-upcoming-content" type="button" role="tab"
                                    aria-controls="transaction-upcoming-content" aria-selected="false">Upcoming</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="transaction-request-tab" data-bs-toggle="tab"
                                    data-bs-target="#transaction-request-content" type="button" role="tab"
                                    aria-controls="transaction-request-content" aria-selected="false">Request</button>
                            </li>
                        </ul>
                ...
                <div class="geex-content__section__content">
                    <div class="tab-content geex-transaction-content" id="geex-transaction-content">
                        <div class="tab-pane fade show active" id="transaction-history-content" role="tabpanel"
                                ...
                                <div class="transaction-type">
                                    <div class="transaction-type__single decrement">
                                        ...
                                        <div class="transaction-type__single__content">
                                            ...
                                            <p class="transaction-type__single__content__subtitle">November 24th, 2020
                                                at 2:45 AM</p>
                                        </div>
                                    </div>
                                    <div class="transaction-type__single decrement">
                                        ...
                                        <div class="transaction-type__single__content">
                                            <h4 class="transaction-type__single__content__title">Upgrade Storage Plan
                                            </h4>
                                            <p class="transaction-type__single__content__subtitle">November 24th, 2020
                                                at 2:45 AM</p>
                                        </div>
                                    ...
                                    <div class="transaction-type__single increment">
                                        ...
                                        <div class="transaction-type__single__content">
                                            ...
                                            <p class="transaction-type__single__content__subtitle">September 5th, 2020
                                                at 11:56 AM</p>
                                        </div>
                                    </div>
                                    <div class="transaction-type__single decrement">
                                        ...
                                        <div class="transaction-type__single__content">
                                            <h4 class="transaction-type__single__content__title">Youtube Monthly
                                                Subcrition</h4>
                                            <p class="transaction-type__single__content__subtitle">September 5th, 2020
                                                at 11:56 AM</p>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="transaction-upcoming-content" role="tabpanel"
                            aria-labelledby="transaction-upcoming-tab">
                            <div class="transaction-content">
                                <div class="transaction-type">
                                    <div class="transaction-type__single increment">
                                        <div class="transaction-type__single__icon">
                        ...
                        <div class="tab-pane fade" id="transaction-request-content" role="tabpanel"
                            aria-labelledby="transaction-request-tab">
                            <div class="transaction-content">
                                <div class="transaction-type">
                                    <div class="transaction-type__single increment">
                                        <div class="transaction-type__single__icon">
                ...
                <div class="geex-content__widget__single__mastercard">
                    ...
                    <div class="geex-content__widget__single__mastercard__bottom single-content">
                        ...
                        <div class="geex-content__widget__single__mastercard__bottom__icon">
                            <img src="{{ asset('img/icon/mastercard-icon.svg') }}" alt="mastercard" />
                ...
                <div class="geex-content__widget__single__content">
                    <div class="geex-content__widget__single__progress primary mb-30">
                        ...
                        <div class="geex-content__widget__single__progress__text">
                            ...
                            <p class="geex-content__widget__single__progress__subtitle"><span>$ 420.26 Used</span> /from
                                $ 1,000</p>
                        </div>
                    </div>
